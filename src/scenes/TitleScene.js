...
export default class TitleScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('button1_01', 'assets/images/ui/button1_01.png');
        this.load.image('button2_01', 'assets/images/ui/button2_01.png');
        this.load.image('button3_01', 'assets/images/ui/button3_01.png');
        this.load.image('button4_01', 'assets/images/ui/button4_01.png');
    ...
    create() {
        ...
        this.add.text(427, 493, 'PLAY', buttonTextStyle).setOrigin(0.5);
        this.add.text(427, 618, 'OPTIONS', buttonTextStyle).setOrigin(0.5);
        this.add.text(427, 752, 'HELP', buttonTextStyle).setOrigin(0.5);
        this.add.text(427, 890, 'EXIT', buttonTextStyle).setOrigin(0.5);
